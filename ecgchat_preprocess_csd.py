...
def prepare(args):
    ...
    for key in data_dict.keys():
        diagnostic_df[key] = data_dict[key]
    diagnostic_df.to_csv(os.path.join(data_dir, "/data_C/sdb1/lyi/ECG-Chat-master/data/champan-shaoxing/diagnostics.csv"))


if __name__ == "__main__":
    parser = argparse.ArgumentParser()
    parser.add_argument("--data-dir", type=str, default="/data_C/sdb1/lyi/ECG-Chat-master/data/champan-shaoxing")
