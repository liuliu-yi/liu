...
def main(args, config):
    #设置设备为 GPU（cuda:1）或 CPU，取决于是否有可用的 GPU。
    ...
    #### Dataset ####
    #加载数据集 根据配置文件中的 ptbxl_use_what_label 字段，加载不同的数据集。
    print("Creating dataset")
    if config["ptbxl_use_what_label"] == "diagnosis_label":   # 44类
        X_train = np.load("/data_C/sdb1/lyi/ECGFM-KED-main/dataset/ptb-xl/output/exp1/data/X_train.npy", allow_pickle = True)
        X_test = np.load("/data_C/sdb1/lyi/ECGFM-KED-main/dataset/ptb-xl/output/exp1/data/X_test.npy", allow_pickle = True)
        y_train = np.load("/data_C/sdb1/lyi/ECGFM-KED-main/dataset/ptb-xl/output/exp1/data/y_train.npy", allow_pickle = True)
        y_test = np.load("/data_C/sdb1/lyi/ECGFM-KED-main/dataset/ptb-xl/output/exp1/data/y_test.npy", allow_pickle = True)
        X_val = np.load("/data_C/sdb1/lyi/ECGFM-KED-main/dataset/ptb-xl/output/exp1/data/X_val.npy", allow_pickle = True)
        y_val = np.load("/data_C/sdb1/lyi/ECGFM-KED-main/dataset/ptb-xl/output/exp1/data/y_val.npy", allow_pickle = True)
        X_report = pd.read_csv("/data_C/sdb1/lyi/ECGFM-KED-main/dataset/ptb-xl/output/exp1.1/data/report_train_clean_final.csv", index_col=[0])
    elif config["ptbxl_use_what_label"] == "subdiagnosis_label":  # 23类
        X_train = np.load("/data_C/sdb1/lyi/ECGFM-KED-main/dataset/ptb-xl/output/exp1.1/data/X_train.npy", allow_pickle = True)
        X_test = np.load("/data_C/sdb1/lyi/ECGFM-KED-main/dataset/ptb-xl/output/exp1.1/data/X_test.npy", allow_pickle = True)
        y_train = np.load("/data_C/sdb1/lyi/ECGFM-KED-main/dataset/ptb-xl/output/exp1.1/data/y_train.npy", allow_pickle = True)
        y_test = np.load("/data_C/sdb1/lyi/ECGFM-KED-main/dataset/ptb-xl/output/exp1.1/data/y_test.npy", allow_pickle = True)
        X_val = np.load("/data_C/sdb1/lyi/ECGFM-KED-main/dataset/ptb-xl/output/exp1.1/data/X_val.npy", allow_pickle = True)
        y_val = np.load("/data_C/sdb1/lyi/ECGFM-KED-main/dataset/ptb-xl/output/exp1.1/data/y_val.npy", allow_pickle = True)
        X_report = pd.read_csv("/data_C/sdb1/lyi/ECGFM-KED-main/dataset/ptb-xl/output/exp1.1/data/report_train_clean_final.csv", index_col=[0])
    elif config["ptbxl_use_what_label"] == "all": # 71类
        X_train = np.load("/data_C/sdb1/lyi/ECGFM-KED-main/dataset/ptb-xl/exp0/data/X_train.npy", allow_pickle=True)
        X_test = np.load("/data_C/sdb1/lyi/ECGFM-KED-main/dataset/ptb-xl/exp0/data/X_test.npy", allow_pickle=True)
        y_train = np.load("/data_C/sdb1/lyi/ECGFM-KED-main/dataset/ptb-xl/exp0/data/y_train.npy", allow_pickle=True)
        y_test = np.load("/data_C/sdb1/lyi/ECGFM-KED-main/dataset/ptb-xl/exp0/data/y_test.npy", allow_pickle=True)
        X_val = np.load("/data_C/sdb1/lyi/ECGFM-KED-main/dataset/ptb-xl/exp0/data/X_val.npy", allow_pickle=True)
        y_val = np.load("/data_C/sdb1/lyi/ECGFM-KED-main/dataset/ptb-xl/exp0/data/y_val.npy", allow_pickle=True)
        #X_report = pd.read_csv("/data_C/sdb1/lyi/ECGFM-KED-main/dataset/ptb-xl/exp0/data/total_report_train_final.csv", index_col=[0])
    elif config["ptbxl_use_what_label"] == "form": #
        X_test = np.load("/data_C/sdb1/lyi/ECGFM-KED-main/dataset/ptb-xl/output/exp2/data/X_test.npy", allow_pickle=True)
        y_test = np.load("/data_C/sdb1/lyi/ECGFM-KED-main/dataset/ptb-xl/output/exp2/data/y_test.npy", allow_pickle=True)
        X_report = pd.read_csv("/data_C/sdb1/lyi/ECGFM-KED-main/dataset/ptb-xl/output/exp2/data/total_report_train_final.csv", index_col=[0])
    elif config["ptbxl_use_what_label"] == "rhythm": #
        X_test = np.load("/data_C/sdb1/lyi/ECGFM-KED-main/dataset/ptb-xl/output/exp3/data/X_test.npy", allow_pickle=True)
        y_test = np.load("/data_C/sdb1/lyi/ECGFM-KED-main/dataset/ptb-xl/output/exp3/data/y_test.npy", allow_pickle=True)
        X_report = pd.read_csv("/data_C/sdb1/lyi/ECGFM-KED-main/dataset/ptb-xl/output/exp3/data/total_report_train_final.csv", index_col=[0])
    else:
        X_test = np.load("/data_C/sdb1/lyi/ECGFM-KED-main/dataset/ptb-xl/output/exp1.1/data/X_test.npy", allow_pickle=True)
        y_test = np.load("/data_C/sdb1/lyi/ECGFM-KED-main/dataset/ptb-xl/output/exp1.1.1/data/y_test.npy", allow_pickle=True)
    #对训练数据进行下采样，减少数据量。
    X_train, y_train= down_sample_train_data(X_train, y_train , config['finetune_sample_rate'])
    # X_report = pd.read_csv("/data_C/sdb1/lyi/ECGFM-KED-main/dataset/ptb-xl/output/exp0/data/total_report_train_final.csv", index_col=[0])
    #创建数据集和数据加载器
    ...
    if config['finetune']:
        ...
        for epoch in range(start_epoch, max_epoch):
            ...
            if best_val_auc < val_auc:
                ...
                file_path = "/data_C/sdb1/lyi/ECGFM-KED-main/model_state/checkpoints_finetune/finetune_ptbxl_" + str(
...
if __name__ == '__main__':
    #加载配置文件：
    yaml = YAML(typ='rt')
    config = yaml.load(open('./configs/Res_train.yaml', 'r'))
    #根据配置选择模型：
    if config['finetune']:
    ...
    for model in model_list:
        if 'no_augment' in model or 'zhipuai' in model:
            model_path = '/data_C/sdb1/lyi/ECGFM-KED-main/' + model
        else:
            model_path = '/data_C/sdb1/lyi/ECGFM-KED-main/' + model
        ...
        torch.cuda._initialized = True
         #根据 finetune 配置，设置日志信息，用于记录当前实验的目的（微调或零样本推理）
        if config['finetune']:
